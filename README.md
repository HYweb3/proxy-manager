...
\`\`\`bash
curl -fsSL https://raw.githubusercontent.com/YOUR_USERNAME/YOUR_REPO/main/install-from-github.sh | bash
\`\`\`

或者直接运行：

\`\`\`bash
bash <(curl -fsSL https://raw.githubusercontent.com/YOUR_USERNAME/YOUR_REPO/main/install-from-github.sh)
\`\`\`
